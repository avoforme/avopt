...
const Work = () => (
  <Layout title="TEDxYouth@PTNK">
    <Container>
      ...
      <P>
        In May 2023, the first TEDxYouth@PTNK event was staged by a group of
        VNU-HCM High School for the Gifted students, in the spirit of bringing a
        TED-like experience to students and TED enthusiasts in Ho Chi Minh City
      </P>
